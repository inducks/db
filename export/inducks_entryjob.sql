...
CREATE TABLE `inducks_entryjob` (
  `entrycode` varchar(19) COLLATE utf8_unicode_ci DEFAULT NULL,
  `personcode` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `transletcol` varchar(1) COLLATE utf8_unicode_ci DEFAULT NULL,
